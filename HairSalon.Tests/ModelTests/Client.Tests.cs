...
namespace HairSalon.Tests
{
    ...
    public class ClientTest : IDisposable
    {
        ...
        {
            Client testClient = new Client(1, "Jeff", "Smith", "805-555-5555", "jeff@aol.com", "bald", 1);
        ...
        {
            Client testClient1 = new Client(1, "Jeff", "Smith", "805-555-5555", "jeff@aol.com", "bald", 1);
            Client testClient2 = new Client(1, "Jeff", "Smith", "805-555-5555", "jeff@aol.com", "bald", 1);
        ...
        {
            Client testClient = new Client(1, "Jeff", "Smith", "805-555-5555", "jeff@aol.com", "bald");
            testClient.Save();
        ...
        public void Update_UpdateClientFromDatabase_String()
        {
            Client testClient = new Client(1, "Jeff", "Smith", "805-555-5555", "jeff@aol.com", "bald");
            testClient.Save();
            testClient.Update(1, "Geoff", "Smith", "805-555-5555", "jeff@aol.com", "bald");
